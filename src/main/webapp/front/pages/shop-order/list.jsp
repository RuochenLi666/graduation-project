									...
									<tr v-for="(item,index) in dataList" v-bind:key="index">
                                        ...
                                        <td style="width: 120px;">
                                                {{item.addtime}}
										                                        ...
										                                        <td style="width: 80px;">
                                            <span v-if="item.qishouname">{{item.qishouname}}<br/><small style="color:#888;">{{item.qishouphone}}</small></span>
                                            <span v-else style="color:#ccc;">暂未分配</span>
                                        </td>
                                        <td style="width: 80px;">
                                            <span :style="item.peisongstatus=='已送达'?'color:green;font-weight:bold':item.peisongstatus=='配送中'?'color:orange':'color:#999'">
                                                {{item.peisongstatus || '待分配'}}
                                            </span>
                                        </td>
