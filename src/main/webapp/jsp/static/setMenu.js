                                ...
                                if(secondMenuName == menuChild[k].tableName && secondMenuName != ""){
                                    ...
                                    var childHrefAttr = "" ;
                                        ...
                                        //订单管理
                                                                    ...
                                                                    }else if(menuChild[k].menuJump && menuChild[k].menuJump != "列表") {
                                                                        childHrefAttr = "${pageContext.request.contextPath}/jsp/modules/" + menuChild[k].tableName + "/" + menuChild[k].menuJump + ".jsp" ;
                                                                    }else {
